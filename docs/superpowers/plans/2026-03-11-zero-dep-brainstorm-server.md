...
> **For agentic workers:** REQUIRED: Use ace:subagent-driven-development (if subagents available) or ace:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
