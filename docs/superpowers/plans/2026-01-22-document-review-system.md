...
> **For agentic workers:** REQUIRED: Use ace:subagent-driven-development (if subagents available) or ace:executing-plans to implement this plan.
...
```markdown
> **For agentic workers:** REQUIRED: Use ace:subagent-driven-development (if subagents available) or ace:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
