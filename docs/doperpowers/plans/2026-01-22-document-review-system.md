...
> **For agentic workers:** REQUIRED: Use doperpowers:subagent-driven-development (if subagents available) or doperpowers:executing-plans to implement this plan.
...
**Spec:** docs/doperpowers/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/doperpowers/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use doperpowers:subagent-driven-development (if subagents available) or doperpowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
