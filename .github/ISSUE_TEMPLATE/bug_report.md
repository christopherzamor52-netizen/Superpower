...
## Is this a Doperpowers issue or a platform issue?
<!-- Doperpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Doperpowers installed.

     If the problem persists without Doperpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Doperpowers installed
